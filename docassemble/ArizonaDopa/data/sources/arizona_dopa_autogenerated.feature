...
Scenario: Generated scenario
  Given I start the interview at "arizona_dopa.yml"
  And the user gets to "az_dopa_download_screen" with this data:
    | var | value | trigger |
    ...
    | case_numbers.there_are_any | True | |
    ...
    | children[0].name.last | Smith | children[0].name.first |
    | children[0].name.middle | Sample answer | children[0].name.first |
    | children[0].name.suffix | Jr. | children[0].name.first |
    ...
    | x.previous_names.there_are_any | True | |
    ...
    | eligibility_acknowledgement | True | |
    | caregivers1_address_on_one_line | Sample answer | |
    | caregivers[0].name.first | Jane | |
    | caregivers[0].name.last | Smith | |
    | children.target_number | 1 | |
    | is_delegating_all_parental_responsibilities | True | |
    | specific_parental_responsibilities_text_1 | Sample answer | |
    | specific_parental_responsibilities_text_2 | Sample answer | |
    | is_military_duration_selected | True | |
    | delegation_start_date | 01/02/2026 | |
    | delegation_end_date | 01/02/2026 | |
    | military_delegation_start_date | 01/02/2026 | |
    | military_delegation_end_date | 01/02/2026 | |
    | principal_signature_date | today | |
    | principal_signature_date | 01/02/2026 | |
    ...
    | az_dopa_intro_ack | Sample answer | |
    | az_dopa_preview_ack | Sample answer | |
    | az_dopa_download | Sample answer | |
    | az_dopa_intro_ack | True | |
    | caregivers[0].name.middle | Sample answer | |
    | caregivers[0].name.suffix | Jr. | |
    | az_dopa_preview_ack | True | |
    | users.revisit | True | |
    ...
    | case_numbers.target_number | 1 | |
    | children[0].previous_names.target_number | 1 | |
    | docket_numbers.target_number | 1 | |
    | other_parties.target_number | 1 | |
    | users.target_number | 1 | |
    | users[0].aliases.target_number | 1 | |
    | users[0].other_addresses.target_number | 1 | |
    | users[0].previous_addresses.target_number | 1 | |
    | users[0].previous_names.target_number | 1 | |
    | x.target_number | 1 | |
    | x.aliases.target_number | 1 | |
    | x.other_addresses.target_number | 1 | |
    | x.previous_addresses.target_number | 1 | |
    | x.previous_names.target_number | 1 | |
    | x[0].pages.target_number | 1 | |
    | children[0].birthdate | 01/02/2015 | children[0].name.first |
    | _ignore_Y2hpbGRyZW5baV0uYmlydGhkYXRl_month | 01 | children[0].name.first |
    | _ignore_Y2hpbGRyZW5baV0uYmlydGhkYXRl_day | 02 | children[0].name.first |
    | _ignore_Y2hpbGRyZW5baV0uYmlydGhkYXRl_year | 2015 | children[0].name.first |
